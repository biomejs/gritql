---
title: Authoring custom patterns
---
...
You can watch [this video](https://www.youtube.com/embed/WICqSP-w2IU?si=KAtvT12uWXaroS_z") to see the extension in action.

[![Authoring Walkthrough](https://img.youtube.com/vi/WICqSP-w2IU/0.jpg)](https://www.youtube.com/watch?v=WICqSP-w2IU)
...
- Subheadings are used for each test case, following these conventions:
  ...
  - Within the sample patterns, you can use `// @filename: example.js` to represent multiple input/output files that should be tested as a group.

## Example

Here is an example of a markdown pattern file:

````markdown title=".grit/patterns/remove_console_log.md"
---
