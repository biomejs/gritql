...
const baseLight: editor.IStandaloneThemeData = {
  inherit: false,
  base: 'vs',
  colors: {
    focusBorder: '#2188ff',
    ...
    'diffEditor.insertedLineBackground': '#E0FFEF',
    'diffEditor.insertedTextBackground': '#74F3B1',
    'diffEditor.removedLineBackground': '#FFE7E6',
    'diffEditor.removedTextBackground': '#FF8D8B',
